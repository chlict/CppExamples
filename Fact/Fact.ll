...
@.str = private unnamed_addr constant [15 x i8] c"fact1<3> = %d\0A\00", align 1
@.str.1 = private unnamed_addr constant [15 x i8] c"fact2(3) = %d\0A\00", align 1
@.str.2 = private unnamed_addr constant [15 x i8] c"fact3(3) = %d\0A\00", align 1

; Function Attrs: norecurse nounwind ssp uwtable
define i32 @main() local_unnamed_addr #0 {
  %1 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i64 0, i64 0), i32 6)
  %2 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i64 0, i64 0), i32 6)
  %3 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i64 0, i64 0), i32 6)
  ret i32 0
}
